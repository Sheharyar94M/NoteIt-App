package playaxis.appinn.note_it.notification
...
class NotificationActivity : AppCompatActivity() {
    ...
    private val viewModel by navGraphViewModel(R.id.nav_graph_notification,R.id.nav_host_main_fragment_container) { viewModelFactory.create(it) }
